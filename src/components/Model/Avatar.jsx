...
Command: npx gltfjsx@6.2.18 668e7776f2eb29b0c8d9026f.glb 
*/
...
export function Avatar(props) {
  ...
  typingAnimation[0].tracks.forEach((item) => {
      item.name = item.name.replace('mixamorig', '');
  });
  fallingAnimation[0].tracks.forEach((item) => {
      item.name = item.name.replace('mixamorig', '');
  });
...
useGLTF.preload('/668e7776f2eb29b0c8d9026f.glb')
